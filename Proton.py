...
def respond(voice_data):
    ...
    elif 'send a mail' in voice_data:
            try:
                reply("What should I say?")
                content = record_audio()
                reply("what is the recipient's mail id")
                to = record_audio()  
                sendEmail(to, content)
                reply("Email has been sent !")
            except Exception as e:
                print(e)
                reply("I am not able to send this email")
